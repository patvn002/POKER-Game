...
# Assignment Description - Game of Dice Poker
...
Games_won = 0     # this will count the number of games won by the user
Games_lost = 0    # this will count the number of games lost by the user
Games_drawn = 0   # this will count the number of games drawn by the user
Games_num = 0     # this will count the number of games played by the user
